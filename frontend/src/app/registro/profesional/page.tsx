...
export const metadata = {
  ...
  description:
    "Regístrate como abogado en Burofy: Únete a nuestra plataforma para conectarte con clientes que requieren tus servicios legales. Expande tu práctica y encuentra nuevos casos de manera rápida y eficiente.",
};
