      ...
      <div className='font-primary-roboto'>
        ...
        <div className='px-4 md:px-12'>
          <Image
            ...
            width={92}
            height={92}
            className='absolute bg-white border-2 border-white rounded-full top-4 xl:top-16'
          />
          <div className='pl-20'>
            <span className='flex items-center justify-center w-fit'>
              <h1 className='pl-5 text-left flex mt-2 min-w-[246px] text-[23px] font-bold'>
                Carlos Fernandez <MdVerified size={28} color='green' className='mx-2' />
              </h1>
            </span>
