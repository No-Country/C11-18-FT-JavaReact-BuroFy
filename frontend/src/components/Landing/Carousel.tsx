...
const slides = [
  {
    ...
    subtitle:
      "Gracias a nuestro sistema de búsqueda avanzada, como cliente encontrarás a los mejores expertos para tus asesorías.",
  ...
  },
  {
    ...
    subtitle:
      "Como profesional, atendiendo las solicitudes de los clientes. Además, podrás generar ingresos extras por ello.",
    image: image2,
  },
  {
    title: "Con Bourofy conectarse es más fácil",
    subtitle:
      "Plataforma diseñada por expertos para brindar soluciones legales al alcance de tu mano",
    image: image3,
  },
];
