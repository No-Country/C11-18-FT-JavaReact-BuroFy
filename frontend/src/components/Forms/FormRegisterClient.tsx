...
export default function FormRegister() {
  ...
  return (
    <motion.div
      className='flex flex-col order-4 w-full h-auto mx-auto mb-2 md:items-center lg:mt-32 lg:mb-0 mt-20'
      initial={{ opacity: 0 }}
    ...
    >
      <div className='flex flex-col items-center font-primary-roboto justify-center h-full m-auto bg-white md:w-full md:h-full'>
        ...
        <footer className='hidden lg:absolute mt-4 text-xs bottom-4'>
