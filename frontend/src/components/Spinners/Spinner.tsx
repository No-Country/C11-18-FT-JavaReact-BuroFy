...
const Spinner = () => {
  return (
    <section className='fixed h-screen w-full bg-white mx-auto flex flex-col gap-20 justify-center items-center z-[98]'>
      <Image src='/assets/header-burofy.svg' alt='title burofy organization' height={250} width={250} />
