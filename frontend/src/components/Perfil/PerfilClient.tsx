    ...
    <div className='h-auto w-[485px]'>
      <section className='flex lg:ml-[40rem]'>
        <div className=''>
          ...
          />
          <AiOutlineEdit className='absolute ml-32 top-[13.5rem] text-xl z-50 lg:absolute lg:ml-[33rem] lg:mt-[15rem] ' />
        </div>
      ...
      <section className='flex ring-offset-2 ring-2 w-[427.68px] h-[579.98] ml-7 items-center justify-center  lg:w-[1235px] lg:h-[425px] lg:ml-[60rem] lg:mt-16'>
        <form className="lg:grid lg:grid-cols-2 lg:items-center lg:justify-center lg:mt-[-3rem]">
          ...
          <h2 className='flex relative font-bold text-2xl mt-6 text-black ml-[3rem] lg:mt-16 lg:items-center lg:justify-center lg:text-2xl lg:mb-16 lg:ml-[-4rem] lg:flex'>
            Andrea Gonzalez
          </h2>
          <h2 className="hidden lg:flex lg:text-xl lg:font-bold lg:relative lg:ml-[4rem] ">08/07/90</h2>
           <BsFillPersonFill className="hidden lg:flex lg:absolute lg:top-[26.3rem] lg:ml-[29rem] lg:text-xl"/>
          
          
          <AiOutlineEdit className='absolute  top-[18.5rem] ml-[15.5rem] text-xl z-50 lg:hidden' />
          ...
          <div className='ml-7 mt-4 font-semibold relative z-0 w-full mb-6 group'>
            <label htmlFor='' className='mt-2'></label>
            <select className="className='block items-center text-center py-2.5 ml-5 px-0 w-3/4 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-lilac peer md:w-96'">
          ...
          <div className='ml-16 mt-12 font-semibold relative z-0 w-full mb-6 group  lg:mr-[7rem]'>
            <button className='bg-primary w-[220px] h-10  read-only:bg-gray-500 mr-16 mt-8 text-lg font-bold text-white rounded-xl lg:w-[320px] lg:h-10 lg:absolute lg:ml-60 lg:mt-[-1rem]'>
              {/* onClick={Next}  */}
              Guardar
            </button>
          </div>
      ...
      <section className='flex  flex-col ring-offset-2 ring-2 w-[427.68px] h-[579.98] ml-7 mt-8 lg:w-[1235px] lg:h-[325px] lg:ml-[60rem] lg:mt-16 lg:flex'>
        ...
        <p className='flex text-xs text-start ml-7 mt-5 lg:absolute lg:text-base lg:ml-24 lg:mt-28'>Método de pago existente</p>
        ...
        <div className='w-[60%] h-32 bg-slate-700 text-white cursor-pointer ml-[4.5rem] mt-16 mb-8 lg:ml-60 lg:w-72 lg:cursor-pointer'>
          ...
          <p className='flex text-xs w-[30%] ml-20 mt-14 absolute lg:ml-6 lg:w-[10%] lg:text-sm'>Agregar tarjeta o Método de pago</p>
        </div>
     </div>
      </section>
      <div className="ring-offset-2 ring-2 w-[427.68px] h-auto ml-7 mt-8 lg:ml-[60rem] lg:w-[1235px]">
      <h2 className='flex items-center justify-center font-bold mt-12 text-2xl lg:ml-[5rem] lg:font-extrabold lg:text-3xl'>Reseñas</h2>

      <div className="ring-offset-2 ring-2 m-8  " id='accordion-collapse' data-accordion='collapse '>
      ...
      <p className='text-xs font-extrabold text-black mt-20 ml-40 lg:ml-[95rem] lg:w-3/4 lg:text-base lg:text-black lg:font-extrabold'>Burofy genera conexiones</p>
    </div>
  );
}
