...
export const CardBuscarCliente = () => {
  return (
    <div className=' m-auto mt-7 items-center justify-center flex-col border border-[#C600E0] w-full h-auto rounded-lg drop-shadow-xl text-center lg:border-2 lg:w-full lg:h-auto  lg:space-y-6'>
      <header className='flex items-center justify-between bg-[#A6ACAF] rounded-t-lg lg:w-full lg:items-center lg:justify-between'>
        <p className='m-3 mx-2 text-xs'>
          N° del servicio:
          <span className='mx-2 bg-[#2e2e2e] text-white text-xs rounded-lg px-2'>875</span>
        </p>
        <p className='mx-2  text-xs '>
          Fecha:
          <span className='mx-2 bg-[#2e2e2e] text-white text-xs rounded-lg px-2'>05/15/2023</span>
        </p>
      </header>
          ...
          <div className='grid grid-cols-2 items-center justify-between '>
            <div className='flex flex-col m-3 items-center justify-center '>
              <p className='mt-3 flex text-xs items-center justify-center'>
                {/* p dinamico */}
                <ImMobile className='text-sm mx-auto' /> +65 5252 545 2565
              </p>
              <p className='mt-3 flex text-xs items-center justify-center'>
                {/* p dinamico */}
            ...
            <div>
              <button className='flex text-xs w-[138px] h-[26px] p-2 bg-[#2e2e2e] text-white items-center justify-center rounded-lg mx-2'>
