            ...
            <div className='flex gap-4 items-center '>
              ...
              <div className='flex-col space-y-3'>
                ...
                <div className="flex gap-2">
                  ...
                  <p className=" text-base font-normal leading-4 text-[#2E2E2E]">{search.location || "n/a" }</p>
                </div>
              </div>
            </div>
            <div>
              <div className='flex lg:flex-col gap-2 lg:gap-0 mt-6 space-y-3'>
                ...
                <p className='lg:font-normal lg:text-sm lg:text-end lg:mb-2 mb-3 text-xs mt-3 lg:mt-0'><strong> ${search.price || "n/a" }</strong> / consulta</p>
                <button
                  type='button'
